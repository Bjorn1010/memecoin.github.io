  ...
  return (
    <label
      className={cn(
        ...
        disabled ? "cursor-not-allowed text-steel-600" : "text-steel-300 hover:text-white",
      )}
    >
      <input
        type="checkbox"
      ...
      <span
        ...
        className={cn(
          ...
          checked ? "border-volt bg-volt text-void" : "border-white/20",
        )}
      >
  ...
  return (
    <div className="space-y-7">
        ...
        <button
          ...
          className={cn(
            ...
            filters.promo
              ...
              : "border-white/15 text-steel-300 hover:border-white/35",
          )}
        >
          En promo
        </button>
      ...
      {groups.map((group) => {
        ...
        return (
          <fieldset key={String(group.key)} className="border-t border-white/8 pt-5">
