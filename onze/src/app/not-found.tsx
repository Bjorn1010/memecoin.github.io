...
export default function NotFound() {
  return (
    <div className="pitch-lines relative flex min-h-[80svh] flex-col items-center justify-center px-5 text-center">
      ...
      <p className="scoreboard relative text-[clamp(6rem,22vw,16rem)] leading-none text-white/8">
        404
      </p>
      <h1 className="relative -mt-6 font-display text-title text-white">Hors-jeu</h1>
