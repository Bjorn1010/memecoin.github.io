...
export default function ComptePage() {
  return (
    <div className="mx-auto max-w-sm px-5 pt-40 pb-24">
      <h1 className="font-display text-title text-ink">Connexion</h1>
      ...
      <p className="mt-10 rounded-md border border-ink/8 bg-surface p-4 text-xs leading-relaxed text-steel-500">
